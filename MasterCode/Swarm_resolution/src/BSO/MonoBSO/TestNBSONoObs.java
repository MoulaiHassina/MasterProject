...
//        generateByNbTarget(nn, MaxIter, localSize);
    ...
    public static void generateByPortee(int nn, int MaxIter, int localSize) throws Exception {
        ...
        int nbrBees,MaxChances,flip;

        write("Resultat/BSO/"+nbrTarget+"Target/TestPortee/testIter.txt");
        write("Resultat/BSO/"+nbrTarget+"Target/TestPortee/testTime.txt");
        write("Resultat/BSO/"+nbrTarget+"Target/TestPortee/testTarg.txt");
        ...
        for (int i = 1; i <= 10; i++) {
            ...
            for(int n=1; n<5; n++) {
                ...
                /** GA **/
                GA genetic = new GA(GaIter, GaPopu, 0, GaMuta);
                para = genetic.GA(nbrTarget, envi, 0).getParameters();

                flip=para.get(0);
                MaxChances=para.get(1);
                nbrBees=para.get(2);

                System.out.println("bso: flip: "+flip+" ,MaxChance: "+MaxChances+" ,nbrBees: "+nbrBees);
                ...
                for (int j = 1; j <= nbrRepete; j++) {
                    ...
                    resultat = nbso.exe2(envi, nbrTarget);
            ...
            write("Resultat/BSO/"+nbrTarget+"Target/TestPortee/testIter.txt", nbnrIter.substring(1));
            write("Resultat/BSO/"+nbrTarget+"Target/TestPortee/testTime.txt", time.substring(1));
            write("Resultat/BSO/"+nbrTarget+"Target/TestPortee/testTarg.txt", nbrTarg.substring(1));
        }
    }
    ...
    public static void generateBySize(int nn,int MaxIter,int localSize) throws Exception {
        ...
        String nbnrIter = "", time = "",  nbrTarg = "";
        ArrayList<Double> resultat ;
        int[] envSize = {50,100,200,400,600,800,1000,1500,3000,5000};//50,100,200,400,600,800,1000,1500,
        int s = 0;
        ArrayList<Integer> para;
        int nbrBees,MaxChances,flip;

        write("Resultat/BSO/"+nbrTarget+"Target/TestSize/testIter.txt");
        write("Resultat/BSO/"+nbrTarget+"Target/TestSize/testTime.txt");
        write("Resultat/BSO/"+nbrTarget+"Target/TestSize/testTarg.txt" );
        ...
        for (int i = 1; i <= envSize.length; i++) {
            ...
            write("Resultat/BSO/"+nbrTarget+"Target/TestSize/testIter.txt", nbnrIter.substring(1));
            write("Resultat/BSO/"+nbrTarget+"Target/TestSize/testTime.txt", time.substring(1));
            write("Resultat/BSO/"+nbrTarget+"Target/TestSize/testTarg.txt", nbrTarg.substring(1));
    ...
    public static void generateByNbTarget(int nn, int MaxIter,int localSize) throws Exception {
        ...
        write("Resultat/BSO/"+nb+"Target/TestNbTarget/testIter.txt");
        write("Resultat/BSO/"+nb+"Target/TestNbTarget/testTime.txt");
        write("Resultat/BSO/"+nb+"Target/TestNbTarget/testTarg.txt");
        ...
        for (int i = 1; i <= envSize.length; i++) {
            ...
            write("Resultat/BSO/"+nb+"Target/TestNbTarget/testIter.txt", nbnrIter.substring(1));
            write("Resultat/BSO/"+nb+"Target/TestNbTarget/testTime.txt", time.substring(1));
            write("Resultat/BSO/"+nb+"Target/TestNbTarget/testTarg.txt", nbrTarg.substring(1));
